...
const NoteList = ({ availableTags, notes, onUpdateTag, onDeleteTag }: Props) => {
    ...
    const filteredNotes = useMemo(() => {
        return notes.filter(note => {
            ...
            //take a look here at note.tags.some - checking to see if some of the tags are included 
            // loop through all of our selected tags, make sure if it contains the tag that we're looking for
        })
